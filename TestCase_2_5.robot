...
TC_002: Invalid Phone Number 
    [Documentation]    ทดสอบกรอกฟอร์มโดยกรอกเบอร์แบบไม่ถูกต้องและตรวจสอบข้อความแจ้งเตือน
    ...
    Input Text    xpath=//input[@id='email']    somsong@
    Input Text    xpath=//input[@id='phone']    191
